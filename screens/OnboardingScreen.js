        ...
        pages={[
            {
              ...
              subtitle: (<View>
                ...
                <Text><Text style={{fontWeight:'bold', textAlign:'center', color:'#A0CE4E', fontSize:19, margin:12,  marginTop: -70}}>We Value your Privacy. Please share your phone number with us so we can track your balance.</Text></Text>
              </View>),
            },
            {
                backgroundColor: '#fff',
